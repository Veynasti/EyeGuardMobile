                    ...
                    Container(
                      ...
                      child: Form(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
                            _buildFormHeader('Masuk Akun', 'Masukkan detail akun Anda untuk melanjutkan'),
                            ...
                            _buildSwitchFormLink(
                              ...
                              () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => RegisterView(apiService: widget.apiService),
                                ),
                              ),
                            ),
                          ],
    ...
    return Align(
      ...
      child: TextButton(
        onPressed: () => Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ForgotPasswordView(apiService: widget.apiService),
          ),
        ),
